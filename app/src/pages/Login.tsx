    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center pb-6">
          ...
          <CardDescription>Sign in to your AMENTA Farm account</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <Button
            className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:text-gray-900"
            variant="outline"
            type="button"
            onClick={() => {
